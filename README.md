...
这是一个开源免费的 intellij Idea 插件，用来查询 Maven 中央仓库的工件
...
如果有开发 intellij Idea 插件的需求，可以发邮件到 jeremy8551@qq.com

如果能提供正式的开发工作，可以发邮件到 jeremy8551@qq.com

If there is a need to develop the IntelliJ Idea plugin, you can send an email to jeremy8551@qq.com

If a formal development position can be provided, you can send an email to jeremy8551@qq.com
