...
import cn.org.expect.intellij.idea.plugin.maven.SearchEverywhereUIFactory;
...
//        SearchEverywhereManager manager = SearchEverywhereManager.getInstance(event.getProject());
        try {
            ...
            SearchEverywhereUI newUI = new SearchEverywhereUIFactory().createView(project, contributors, spellingCorrector);
