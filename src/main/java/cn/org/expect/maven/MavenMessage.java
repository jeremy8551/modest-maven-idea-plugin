...
public class MavenMessage {
    ...
    static {
        ...
        if ("取消".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "zh_CN");
        } else if ("Cancelación".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "es_ES");
        } else if ("Annulation".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "fr_FR");
        } else if ("キャンセル".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "ja_JP");
        } else if ("취소".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "ko_KR");
        } else if ("Отменить".equals(CommonBundle.getCancelButtonText())) {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "ru_RU");
        } else {
            System.setProperty(ResourcesUtils.PROPERTY_RESOURCE_LOCALE, "");
        }
